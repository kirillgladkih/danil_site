    ...
    <div class="inner_main">
        <div class="container-fluid">
            <div class="card-header mt-5">
                <h3 class="text-center" style="color: #333333">Заказы</h3>
            </div>
                    ...
                    <tbody>
                       @foreach ($orders as $item)
                           <tr class="order-{{ $item->id }}">
                                ...
                                <td>
                                    @php $data = json_decode($item->products) @endphp
                                ...
                                <td width='50px'>
                                    <button class="btn btn-primary order" value="{{ $item->id }}" 
                                        data-block="order-{{ $item->id }}">
                                        +
                                    </button>
                                </td>
                           </tr>
